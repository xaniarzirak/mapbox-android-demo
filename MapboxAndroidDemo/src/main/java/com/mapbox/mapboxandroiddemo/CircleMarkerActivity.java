...
public class CircleMarkerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_circle_marker);
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final MapboxMap mapboxMap) {
                ...
                IconFactory iconFactory = IconFactory.getInstance(CircleMarkerActivity.this);
                Drawable iconDrawable = ContextCompat.getDrawable(CircleMarkerActivity.this, R.drawable.circle_icon);
